...
<center>
	...
	<tr><td width="110"><a href="./product?prodId=${product.key.id}"><img width="110" src="./resources/images/${product.key.id}.jpg"></a></td>
		<td width="260"><a href="./product?prodId=${product.key.id}" style="text-decoration:none;"><div class="title">${product.key.name}</div></a></td>
		<td width = "300">
		<div id="formLine">
			<img id="imgMinus" src="./resources/images/minus.png" width="25" height = "25" onclick="minus(${product.key.id})"/>
			<input type="text" name="amount" id="qnt${product.key.id}" value="${product.value}" size="2" />
			<img id="imgPlus" src="./resources/images/plus.png" width="25" height = "25" onclick="plus(${product.key.id})"/>
		</div>
		</td>
	<td align="right">
		<form action="./cart" method="post">
			<input type="hidden" name="deleteById" value="${product.key.id}"/>
			<input type="image" src="./resources/images/trash.png" width="70" height = "70" alt="">
		</form>
	</td>
	</tr>
	</table>
